...
public class ApplicationUserService implements UserDetailsService {
    ...
    public String responseUser() {
        ...
        res += String.format("\"phone1\": \"%s\",", user.getPhone1());
        res += String.format("\"phone2\": \"%s\",", user.getPhone2());
        res += String.format("\"role\": \"%s\",", user.getRole());
        res += String.format("\"lastName\": \"%s\"", user.getLastName());
        res += "}";
        return res;
    }
